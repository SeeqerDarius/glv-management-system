...
const dateFields: Record<string, string[]> = {
  ...
  idempotencyKeys: ["createdAt", "expiresAt"],
  customers: ["createdAt"],
  ...
  legalTemplates: ["createdAt", "updatedAt"],
  customerDocuments: ["createdAt"],
  customerMessages: ["scheduledAt", "sentAt", "createdAt", "updatedAt"],
  smsNotifications: ["scheduledAt", "sentAt", "createdAt", "updatedAt"],
